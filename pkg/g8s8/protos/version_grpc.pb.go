...
func (c *versionServiceClient) GetVersion(ctx context.Context, in *VersionRequest, opts ...grpc.CallOption) (*VersionReply, error) {
	out := new(VersionReply)
	err := c.cc.Invoke(ctx, "/virmgrpc.VersionService/GetVersion", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedVersionServiceServer) GetVersion(context.Context, *VersionRequest) (*VersionReply, error) {
...
func _VersionService_GetVersion_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/virmgrpc.VersionService/GetVersion",
	}
...
var VersionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "virmgrpc.VersionService",
	...
	Metadata: "vipu-protos-1.18.0/version.proto",
}
